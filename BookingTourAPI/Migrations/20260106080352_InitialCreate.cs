        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlightOfferId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    TravelerPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightOrders", x => x.OrderId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TravelClass = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TopDestinations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyIncludes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PolicyExcludes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyItineraries_TourPackages_TourPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceInfant = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AvailableSeats = table.Column<int>(type: "int", nullable: false),
                    Airline = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FlightNumberOut = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FlightNumberIn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FlightTimeOut = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FlightTimeIn = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TourDepartures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TourDepartures_TourPackages_TourPackageId",
                        column: x => x.TourPackageId,
                        principalTable: "TourPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TourBookings_TourDepartures_TourDepartureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyItineraries_TourPackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourBookings_TourDepartureId",
                table: "TourBookings",
                column: "TourDepartureId");

            migrationBuilder.CreateIndex(
                name: "IX_TourDepartures_TourPackageId",
